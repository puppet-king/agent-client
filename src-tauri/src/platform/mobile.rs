use tauri::{Builder, Wry, App, AppHandle, Runtime};
use crate::logger;
use tauri_plugin_vpn_helper::{VpnHelperExt, PingRequest, StartVpnRequest};
use std::fs;
...
#[tauri::command]
pub async fn start_vpn<R: Runtime>(app: AppHandle<R>, config_path: String) -> Result<String, String> {
